...
**Note on paths:** these files are in philly/designs
...
- User is done manually fairing the curves in LibreCAD, tracing new spline-through-points
  curves on new layers over the raw data, skipping known-noisy points
...
3. **Build the hull as a loft/shell**, roughly:
   ...
   - Shell the solid to a printable wall thickness (say 4mm to start)
